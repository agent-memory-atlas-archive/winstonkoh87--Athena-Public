...
[![Version](https://img.shields.io/badge/v9.9.9-10b981?style=for-the-badge&label=Version)](docs/CHANGELOG.md)
...
| **SDK** | `athena` Python package (v9.9.9) |
...
<details>
- **Full Synchronized Digital Portfolio Refresh** (2026-09-25): Synchronized portfolio update across all public surfaces. Updated canonical CAPS counts (421 active protocols / 455 total across 26 categories, 43 active skills, 74 workflows, 279 scripts, 199 canonical entries, 503 case studies, 4,960 memories).
- **Full Synchronized Digital Portfolio Refresh** (2026-09-23): Synchronized portfolio update across all public surfaces. Updated canonical CAPS counts (421 active protocols / 455 total across 26 categories, 43 active skills, 74 workflows, 279 scripts, 199 canonical entries, 503 case studies, 4,948 memories).
- **Full Synchronized Digital Portfolio Refresh** (2026-09-22): Synchronized portfolio update across all public surfaces. Updated canonical CAPS counts (421 active protocols / 455 total across 26 categories, 43 active skills, 74 workflows, 279 scripts, 199 canonical entries, 503 case studies, 4,897 memories).
...
- **Full Synchronized Digital Portfolio Refresh** (14 September 2026): Synchronized portfolio update across all public surfaces, releases, wiki, and internal docs. Updated canonical CAPS counts (419 active protocols / 453 total across 26 categories, 43 active skills, 74 workflows, 275 scripts, 199 canonical entries, 502 case studies, 4,735 memory files).
- **Full Synchronized Digital Portfolio Refresh** (13 September 2026): Synchronized portfolio update across all public surfaces. Ported Epistemic Grounding Gate (hook_epistemic_gate.py), Reflexion Compiler router (check_reflexion_compile.py), intake authority and end-user capability triggers (T6/T7), and web provider telemetry. Updated canonical CAPS counts (419 active protocols across 26 categories, 43 skills, 74 workflows, 275 scripts, 502 case studies, 4,695 memories).
- **Full Synchronized Digital Portfolio Refresh** (12 September 2026): Synchronized portfolio update across all public surfaces. Updated canonical CAPS counts (419 active protocols across 26 categories, 43 skills, 74 workflows, 273 scripts, 502 case studies, 4,668 memories).
...
- **Full Synchronized Digital Portfolio Refresh** (7 September 2026): Synchronized portfolio update across all public surfaces. Ported ASCII currency compliance updates to hook_meta_awareness_gate.py. Updated canonical CAPS counts (419 active protocols / 453 total across 26 categories, 43 active skills, 74 workflows, 273 scripts, 199 canonical entries, 4,569 memories).
- **Full Synchronized Digital Portfolio Refresh** (6 September 2026): Synchronized portfolio update across all public surfaces. Ported Meta-Awareness Gate v3.1 recall hardening & cross-harness context_gate MCP bridge, OWASP ASI06 canonical gate, search channel health tracking, calibration scoring, and retrieval audit tooling to public repo. Updated canonical CAPS counts (419 active protocols / 453 total across 26 categories, 43 active skills, 74 workflows, 273 scripts, 199 canonical entries, 4,545 memory files).
- **Full Synchronized Digital Portfolio Refresh** (5 September 2026): Synchronized portfolio update across all public surfaces. Ported runtime verification mandate for cross-model validation (Protocol 171), Red-Team Review v4.3 Strategic Matrix, link integrity engine, and currency integrity guard to public repo. Updated canonical CAPS counts (419 active protocols / 453 total across 26 categories, 43 active skills, 74 workflows, 273 scripts, 199 canonical entries, 4,527 memory files).
...
- **Full Synchronized Digital Portfolio & Feature Port Refresh** (Aug 27 2026): Ported 12 new intelligence, verification, and workflow modules to public repo (`gto_engine.py`, `personalisation.py`, `harness_score.py`, `claim_id.py`, `_venv_bootstrap.py`, `daily.md`, `portfolio-refresh.md`, etc.). Updated canonical CAPS counts (414 active protocols across 26 categories, 43 active skills, 74 workflows, 268 scripts, 4,357 memory files). Filed new domain-specific case studies and operational codifications across decision analysis, ontological arena modeling, and institutional deterrence dynamics.
...
- **Full Synchronized Digital Portfolio Refresh** (Aug 22 2026): Synchronized complete portfolio update across all 4 public surfaces, releases, wiki, and internal docs. Updated canonical CAPS counts (414 active protocols across 26 categories, 43 active skills, 72 workflows, 260 scripts, 4,307 memory files). Filed new domain case studies across trading and variance management.
- **Full Synchronized Digital Portfolio Refresh** (Aug 21 2026): Synchronized complete portfolio update across all 4 public surfaces, releases, wiki, and internal docs. Updated canonical CAPS counts (414 active protocols across 26 categories, 43 active skills, 72 workflows, 260 scripts, 4,301 memory files). Filed new domain case studies.
- **Full Synchronized Digital Portfolio Refresh** (Aug 11 2026): Synchronized complete portfolio update across all 4 public surfaces, releases, wiki, and internal docs. Updated canonical CAPS counts (414 active protocols across 26 categories, 43 active skills, 72 workflows, 260 scripts, 4,234 memory files). Filed new domain case studies.
- **Full Synchronized Digital Portfolio Refresh** (Aug 8 2026): Updated date references, canonical metrics (448 protocols, 43 active skills, 72 workflows, 260 scripts, 4,209 memory files) across all 4 public surfaces, releases, wiki, and internal docs.
